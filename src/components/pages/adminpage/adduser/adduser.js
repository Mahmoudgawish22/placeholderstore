...
import { signUpFromCP } from '../../../../actions/users'
...
const Adduser = () => {
  const [user, setUser] = useState(JSON.parse(localStorage.getItem('profile')));
    ...
    const handleSignUpSubmit = (e) => {
      ...
      dispatch(signUpFromCP(signFormData, setDoneModal, setLoadingModalShow, setErrorLoginRespond));
    }

    const clear = ()=> setSignFormData({ name: " ",
    firstName: " ",
    lastName: ' ',
    password: ' ',
    Passwordrepeat: ' ',
