...
function All(props) {
  ...
  const [firstEightProducts, setProductsState] = useState(0)
    ...
    return (
        <div id='all_products'>
            <div id='offers__title'>
                <label style={{fontSize: '27px'}} className='section__title'> #All Products</label>
                <a className='seemore' style={{cursor: 'pointer'}} onClick={()=> openPosts('forall')}>See More</a>
            </div>
            {display2? 
