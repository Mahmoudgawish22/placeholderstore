...
import '../loginsignpage/logSign.css'
...
export default function SignLogin(props) {
    ...
    const handleLogInSubmit = (e) => {
      ...
      dispatch(signIn(loginFormData, setLoadingModalShow, setErrorLoginRespond, history));
    }
    ...
    const [signFormData, setSignFormData] = useState({
      ...
      photo: ' ',
      userStatus: 'user',
      dateOfRigester: new Date().toDateString(),
      liked: [],
      cart: [],
      recentlyView: [],
      orders: [],
    ...
    const handleSignUpSubmit = (e) => {
      e.preventDefault();
      setLoadingModalShow(true);
      dispatch(signUp(signFormData, setLoadingModalShow, setErrorLoginRespond, history));
    }
    if (!user?.result?.name) {
    return (
        <div id='login_sign'>
                <h1 id='title'>
                  Welcome To Placeholder, It's A Big Honor To Choose Us.
                  </h1>
                {status? 
              ...
              :<span></span>
                ...
                :<form id='signup' onSubmit={handleLogInSubmit}>
              ...
              :<span></span>
                ...
                <div class="form-group">
                  <label className='form_label' for="Email">Email address</label>
                  <input type="email" name='email' class="form-control" value={loginFormData.email} onChange={handleLogInChange} id="Email" aria-describedby="emailHelp" placeholder="Enter email" required/>
                </div>
                <div class="form-group">
                  <label className='form_label' for="Password">Password</label>
                  <input type="password" name='password' className="form-control" value={loginFormData.password} onChange={handleLogInChange} id="Password" placeholder="Password" required/>
                </div>
                <button type="submit" className="btn btn-dark">Submit</button>
              </form>
              }
              {status==false? <div><h1 className='text-center check'>Don't Have An Account?</h1><button onClick={()=> setStatus(true)} class='btn btn-link check text-center'>you can sign-up here</button></div>
              :<div><h1 className='text-center check'>Have An Account?</h1><button onClick={()=> setStatus(false)} class='btn btn-link check'>you can log-in here</button></div>}
              <LoadingModal
